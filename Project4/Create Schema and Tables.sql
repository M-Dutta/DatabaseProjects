...
foreign key (profId) references Project4.Professor(id),
foreign key (crsCode) references Project4.Course(crsCode)
);
...
foreign key (studId) references Project4.Student(id),
foreign key (crsCode) references Project4.Course(crsCode),
foreign key (crsCode, semester) references Project4.Teaching(crsCode, semester)
);